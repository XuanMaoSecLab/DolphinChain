...
- [https://github.com/XuanMaoSecLab/DolphinChain/tree/master/tools/tm-monitor](https://github.com/XuanMaoSecLab/DolphinChain/tree/master/tools/tm-monitor)
...
```
docker run -it --rm -v "/tmp:/tendermint" XuanMaoSecLab/DolphinChain init
docker run -it --rm -v "/tmp:/tendermint" -p "26657:26657" --name=tm --link=app XuanMaoSecLab/DolphinChain node --proxy_app=tcp://app:26658
...
```
docker run -it --rm -v "/tmp:/tendermint" XuanMaoSecLab/DolphinChain init
docker run -it --rm -v "/tmp:/tendermint" -p "26657:26657" --name=tm XuanMaoSecLab/DolphinChain node --proxy_app=kvstore
...
[Install Tendermint](https://github.com/XuanMaoSecLab/DolphinChain#install)
